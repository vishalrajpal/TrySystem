...
public enum Gramlet {
    ...
    CNPQN,
    NVPNCPN,
    WVNVPNN, NPQN, NVNNPN, NPN, VNPN, QNPN, QNP, NVPNVN, NVPNPNVN, VNPNPN, VNPNP,
    NVNQNN, WNVVEVQNP, NVPQN, EVNPNQN, NVQNNPN, NVPNQN, NVVPQNP, NVNPQNP, NVQNWNEVPN, WNVVVNQNP, WNVVVNQNPN, WNVN, NVQNPNCQNP,NVQNVV,
    P,
    NVQN;
